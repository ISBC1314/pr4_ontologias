...
/**
 * This test case creates an inference model binding an ontology model to pellet using the Jena Api, then asserts not null on load and serialization of thededections model.
 * @author <a href="richard.murphy@gsa.gov">Rick Murphy</a>
 * @version %I%,%G%
 */
public class DeductionsModelTestCase extends TestCase{
  ...
  /**
   * Test not null assertion on model load for the deductions model
   */
  public void testModelLoad(){
    assertNotNull("not null on load:", inferenceModel.getDeductionsModel());
  }//testModelLoad

  /**
   * Test not mull assertion on the default writer for the deductions model
   */
  public void testWriter(){
    assertNotNull("not null on default writer:",inferenceModel.getDeductionsModel().getWriter());
  }//testModelLoad

}//DeductionsModelTestCase
